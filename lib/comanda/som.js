...
let audioAvisoTempo = null;

// Arquivo escolhido pelo dono do restaurante (public/hehe.mp3) — diferente
// do sininho de pedido novo, pra dar pra distinguir "hora de olhar o tempo"
...
export function tocarAvisoTempo() {
  ...
  if (!audioAvisoTempo) {
    audioAvisoTempo = new Audio('/hehe.mp3');
  }
  audioAvisoTempo.currentTime = 0;
  audioAvisoTempo.play().catch((err) => console.error('Falha ao tocar aviso de tempo:', err));
}
