...
// Fecha a conta da mesa: aplica cortesia nos itens escolhidos, ajusta taxa
// de serviço e desconto (undefined mantém o valor atual) e confirma o
// pagamento — tudo numa transação só no banco.
export async function fecharContaPedido(supabase, pedidoId, { formaPagamento, taxaServico, desconto, itensCortesiaIds }) {
  const { error } = await supabase.rpc('fechar_conta_pedido', {
