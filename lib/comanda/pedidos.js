...
// Mesa não define forma de pagamento na criação do pedido (só se sabe na
// hora de fechar a conta) — isso marca pago e a forma junto, ou desfaz os
// dois quando formaPagamento vem null (staff escolheu errado e quer trocar).
export async function definirPagamentoMesa(supabase, pedidoId, formaPagamento) {
