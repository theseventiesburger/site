...
const produtos = [
  {
    id: 'new-castle',
    nome: 'New Castle',
    descricao: 'Hambúrguer de 160g grelhado na brasa, ovo frito, bacon super crocante, queijo muçarela derretido e maionese da casa.',
    preco: 'R$ 34,90',
    imagem: '/hb2.png',
    tag: 'O Mais Pedido 🔥',
    categoria: 'especiais',
  },
  {
    id: 'metro-black',
    nome: 'Metro Black',
    descricao: 'Hambúrguer de 160g suculento, alface americana, tomate selecionado, queijo muçarela e maionese artesanal.',
    preco: 'R$ 31,90',
    imagem: '/hb2.png',
  ...
  },
  {
    id: 'gorgon',
    nome: 'Gorgon',
    descricao: 'Hambúrguer de 160g, gorgonzola marcante, rúcula fresca, mel silvestre, cebola crispy e maionese da casa.',
    preco: 'R$ 38,90',
    imagem: '/hb2.png',
  ...
  },
  {
    id: 'classic-smash',
    nome: 'Classic Smash',
    descricao: 'Dois smash patties de 80g, queijo cheddar duplo, picles crocante, cebola caramelizada e molho especial.',
    preco: 'R$ 36,90',
    imagem: '/hb2.png',
    categoria: 'classicos',
  },
  {
    id: 'combo-new-castle',
    nome: 'Combo New Castle',
    descricao: 'New Castle + batata rústica grande + refrigerante 400ml. O combo mais pedido da casa.',
    preco: 'R$ 52,90',
    imagem: '/hb2.png',
    tag: 'Mais Econômico 💰',
    categoria: 'combos',
  },
  {
    id: 'combo-gorgon',
    nome: 'Combo Gorgon',
    descricao: 'Gorgon + batata frita temperada + refrigerante ou suco 400ml.',
    preco: 'R$ 57,90',
    imagem: '/hb2.png',
    categoria: 'combos',
  },
  {
    ...
    descricao: 'Coca-Cola, Guaraná Antarctica, Sprite ou Fanta. Gelado na hora.',
    preco: 'R$ 7,90',
    imagem: '/hb2.png',
    categoria: 'bebidas',
  },
  {
    id: 'milk-shake',
    nome: 'Milk Shake',
    descricao: 'Chocolate, morango, ovomaltine ou baunilha. 400ml com muito creme.',
    preco: 'R$ 19,90',
    imagem: '/hb2.png',
    tag: 'Favorito 🥛',
    categoria: 'bebidas',
  },
  {
    ...
    descricao: 'Brownie quentinho de chocolate meio amargo com bola de sorvete de baunilha e calda.',
    preco: 'R$ 16,90',
    imagem: '/hb2.png',
              ...
              <div className="p-5 flex flex-col flex-grow">
                ...
                <div className="mt-5 pt-4 border-t border-gray-100 flex items-center justify-between">
                  <div className="flex flex-col">
                    ...
                    <span className="text-2xl font-black text-sv-dark">{produto.preco}</span>
                  </div>

                  <Link
                    href={`/pedido/${produto.id}`}
