-- Reaplica só a função criar_pedido (segura rodar quantas vezes precisar —
-- "create or replace" não dá erro de "já existe"). Use isso se rodou o
-- 0006_adicionais.sql e ele parou antes de chegar na função por causa de
-- um erro de "relation already exists" em algum passo anterior.
