-- Bebida do combo escolhida na hora do pedido: até aqui o combo sempre
-- levava a bebida fixa de combo_config. Agora o item pode mandar
-- "combo_bebida_id" — só vale uma bebida ativa da MESMA categoria da
-- bebida padrão do combo (não dá pra colocar um hambúrguer no lugar da
-- bebida). Sem o campo, segue a bebida padrão como sempre. Mesma
-- assinatura de 0038 — só muda o corpo. Rode este arquivo inteiro no SQL
-- Editor do Supabase.
